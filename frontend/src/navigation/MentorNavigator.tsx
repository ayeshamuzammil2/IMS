...
import { LayoutDashboard, GraduationCap, CalendarCheck, ShieldAlert, History, FileCheck2, ScanFace, Award, IdCard, GitBranch, ClipboardList, MessageCircle } from 'lucide-react-native';
